...
const char* mX_vs_mY_nofloat(const char* textfile = 0, TH2D* inputHist = 0, const char* rootfile = "mgluinomlsp2_nofloat.root", TString id1="mgluino",TString id2="mlsp", int   nbinsX=100,int nbinsY=100, float minX=0,float maxX=1600, float minY=0, float maxY=1600)
{
  ...
  TH2D* sigp1;
   ...
   TH2D* sigp1expclsf;
   if (inputHist!=NULL){
    cout<<"make sigp1expclsf from histogram"<<endl;
    ...
    cout<<"make sigp1expclsf from text file"<<endl;                                                                                                          
   ...
   if (inputHist!=NULL){
     ...
     cout<<" make sigclsu1s from histogram"<<endl;
     ...
     cout<<" make sigclsu1s from text file"<<endl;
  ...
  if (inputHist!=NULL){
     ...
     cout<<" make sigclsd1s from histogram"<<endl;
     ...
     cout<<" make sigclsd1s from text file"<<endl;
