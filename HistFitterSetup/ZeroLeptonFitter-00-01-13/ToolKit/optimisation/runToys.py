...
parser.add_argument("-o", "--outputdir", default=os.path.join(os.getenv('ZEROLEPTONFITTER'), 'toys'), type=str, help="output dir under which the dir for the optimisation will be placed (default: {0})".format(os.path.join(os.getenv('ZEROLEPTONFITTER'), 'toys')))
