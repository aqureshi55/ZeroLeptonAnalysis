...
regionDict["VRW"] = Region ("VRW",  "CRWT", ["(lep1Triggered & 0x03)!=0 && lep1Signal==1 &&  nBJet==0 && lep1Pt>27 && 30<MT\
W && MTW<100"], ["btagSystWeights[0]","lepTrigSF"])
regionDict["VRWa"] = Region("VRWa", "CRWT", ["(lep1Triggered & 0x03)!=0 && lep1Signal==1 &&  nBJet==0 && lep1Pt>27 && 30<MT\
W && MTW<100"], ["btagSystWeights[0]","lepTrigSF"])
regionDict["VRWb"] = Region("VRWb", "CRWT", ["(lep1Triggered & 0x03)!=0 && lep1Signal==1 &&  nBJet==0 && lep1Pt>27 && 30<MT\
W && MTW<100"], ["btagSystWeights[0]","lepTrigSF"])
#regionDict["CRWL"] = Region("VRWL", "CRWT", ["nBJet==0"], ["btagSystWeigh
#regionDict["CRWVL"] = Region("VRWVL", "CRWT", ["nBJet==0"], ["btagSystWei
regionDict["VRT"] = Region("VRT", "CRWT",   ["(lep1Triggered & 0x03)!=0 && lep1Signal==1 && nBJet>0  && lep1Pt>2 && 30<MT\
W && MTW<1007"], ["btagSystWeights[0]","lepTrigSF"])
regionDict["VRTa"] = Region("VRTa", "CRWT", ["(lep1Triggered & 0x03)!=0 && lep1Signal==1 && nBJet>0  && lep1Pt>27 && 30<MT\
W && MTW<100"], ["btagSystWeights[0]","lepTrigSF"])
regionDict["VRTb"] = Region("VRTb", "CRWT", ["(lep1Triggered & 0x03)!=0 && lep1Signal==1 && nBJet>0  && lep1Pt>27 && 30<MT\
W && MTW<100"], ["btagSystWeights[0]","lepTrigSF"])
